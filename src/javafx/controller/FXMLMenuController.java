...
public class FXMLMenuController implements Initializable {
    ...
    @FXML
    private MenuItem menuItemVacina;
    @FXML
    private MenuItem menuItemVeterinario;
    @FXML
    ...
    @FXML
    public void handleMenuItemProcessoAgendamento() throws IOException {
        AnchorPane a = (AnchorPane) FXMLLoader.load(getClass().getResource("/javafx/view/FXMLProcessoAgendamento.fxml"));
        anchorPaneCarregar.getChildren().setAll(a);
    }
