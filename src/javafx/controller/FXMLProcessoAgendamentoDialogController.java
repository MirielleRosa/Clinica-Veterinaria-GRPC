 ...
 * @author linha
 */
public class FXMLProcessoAgendamentoDialogController implements Initializable {
  ...
  @FXML
    public void handleButtonConfirmar() {
        if (validarEntradaDeDados()) {
            agendamento.setData(DatePickerAgendamentoData.getValue());
            agendamento.setHora(LocalTime.parse(comboBoxAgendamentoHora.getValue()));
            ...
            // Verifica se o animal já possui uma consulta agendada para o dia selecionado
            List<Agendamento> consultas = agendamentoDAO.contarConsultasDoAnimalNoDia(animal, data);

            if (!consultas.isEmpty()) {
                Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setTitle("Erro");
                alert.setHeaderText("Animal já possui uma consulta agendada para o dia selecionado");
                alert.setContentText("O animal já possui uma consulta agendada para o dia selecionado. Por favor, selecione outro dia ou outro animal.");
                alert.showAndWait();
                return;
            }
